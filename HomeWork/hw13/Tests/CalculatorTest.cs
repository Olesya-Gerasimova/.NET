...
namespace Tests
{
    public class CalculatorTest : IClassFixture<WebApplicationFactory<Startup>>
    {
        private readonly WebApplicationFactory<Startup> _factory;

        public CalculatorTest(WebApplicationFactory<Startup> factory)
        {
            _factory = factory;
        }
        ...
        {
            // Arrange
            var url = $"/Calculator?request={UrlEncoder.Create().Encode(expr)}";
